...
1. Подписывается на канал для получения балансов и получает информацию о балансе от гейта.
2. Подписывается на канал для получения ордербуков.
3. Получает информацию об ордербуках от гейта.
4. Получает среднее арифметическое значение ордербуков.
5. Из полученных средних значений выполняет рассчет ордеров.
6. Рассчитывает минимальные и максимальные границы из средних значений.
7. Если нет выставленного ордера на продажу и есть BTC, то выставлят ордер на продажу.
8. Если нет выставленного ордера на покупку и есть USDT, то выставлят ордер на покупку.
9. Если есть выставленный ордер на продажу, но усредненное лучшее предложение (avg_ask) за пределами удержания, то отменят ордер.
10. Если есть выставленный ордер на покупку, но усредненное лучшее предложение (avg_bid) за пределами удержания, то отменят ордер.
11. Возвращается к пункту 3.
